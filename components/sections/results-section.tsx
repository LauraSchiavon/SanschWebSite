...
const resultData = [
  { month: 'Jan', followers: 1200, engagement: 2.4, cpl: 5.2 },
  { month: 'Fev', followers: 1800, engagement: 2.9, cpl: 4.8 },
  { month: 'Mar', followers: 2400, engagement: 3.2, cpl: 4.2 },
  { month: 'Abr', followers: 2900, engagement: 3.6, cpl: 3.9 },
  { month: 'Mai', followers: 3600, engagement: 4.1, cpl: 3.5 },
  { month: 'Jun', followers: 4200, engagement: 4.5, cpl: 3.0 }
]
    ...
    <section id="results" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Estratégias que geram crescimento real e mensurável para nossos clientes.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <h3 className="text-xl font-semibold text-[#14213D] mb-6">Crescimento de Seguidores</h3>
            <div className="h-72">
                ...
                >
                  <defs>
                    <linearGradient id="colorFollowers" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <stop offset="95%" stopColor="#14213D" stopOpacity={0.1}/>
                    </linearGradient>
                  </defs>
          ...
          <motion.div
            ...
            className="bg-white p-6 rounded-xl shadow-lg"
          >
            <h3 className="text-xl font-semibold text-[#14213D] mb-6">Redução no Custo por Lead</h3>
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={resultData}
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-[#14213D]">{metric.value}</h3>
