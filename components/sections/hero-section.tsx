...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center bg-white overflow-hidden pt-[6rem]"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#14213D]">
              ...
              <span className="text-[#FCA311] block mt-2">
                digital em resultados reais
              </span>
            </h1>

            <p className="mt-6 text-xl text-gray-600 max-w-2xl">
              A Sansch potencializa seu negócio através de estratégias
              personalizadas de social media e tráfego pago para gerar mais
            ...
            <div className="mt-10 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center md:justify-start">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/5514997342092?text=Olá!%20Gostaria%20de%20solicitar%20um%20orçamento.",
                    "_blank"
                  )
                }
              >
