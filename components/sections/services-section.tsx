...
const services = [
  {
    ...
    description:
      "Cuidamos de todo o processo de criação, publicação e análise de conteúdo para suas redes sociais, gerando engajamento e fortalecendo sua presença digital.",
  ...
  },
  {
    ...
    description:
      "Produzimos conteúdos relevantes e otimizados para diferentes plataformas, aumentando seu alcance e autoridade no mercado.",
  ...
  },
  {
    ...
    title: "Meta Ads",
    description:
      "Campanhas publicitárias otimizadas para Facebook e Instagram que geram leads, vendas e resultados mensuráveis para seu negócio.",
    ...
    image:
      "https://images.pexels.com/photos/7172646/pexels-photo-7172646.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    id: 4,
    title: "Google Ads",
    description:
      "Estratégias de anúncios no Google para captar clientes no momento exato em que buscam por seus produtos ou serviços.",
  ...
  },
  {
    ...
    description:
      "Monitoramento e otimização de campanhas de tráfego pago para garantir o melhor custo por aquisição e ROI para seu negócio.",
    ...
    <section id="services" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Oferecemos soluções completas para potencializar sua presença
            digital e transformar visitantes em clientes.
          </motion.p>
        </div>
                ...
                service.id === activeService && (
                  ...
                  >
                    ...
                    <div className="p-6 md:p-8">
                      ...
                      <h4 className="font-semibold text-[#14213D] mb-4">
                        O que incluímos:
                      </h4>
                      <ul className="space-y-2 mb-8">
                        {service.features.map((feature, idx) => (
                          <li key={idx} className="flex items-center">
                            <svg
                              className="h-5 w-5 text-[#FCA311] mr-2"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://wa.me/5514997342092?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20" +
